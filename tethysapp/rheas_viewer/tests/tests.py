    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.rheas_viewer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.rheas_viewer.tests.tests"

        To run tests in the RheasViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.rheas_viewer.tests.tests.RheasViewerTestCase"

        To run only the test_if_tethys_platform_is_great function in the RheasViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.rheas_viewer.tests.tests.RheasViewerTestCase.test_if_tethys_platform_is_great"
